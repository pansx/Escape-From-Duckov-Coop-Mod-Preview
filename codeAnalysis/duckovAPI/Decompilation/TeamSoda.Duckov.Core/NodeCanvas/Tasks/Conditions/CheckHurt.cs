...
namespace NodeCanvas.Tasks.Conditions
{
    ...
    public class CheckHurt : ConditionTask<AICharacterController>
    {
        ...
        protected override bool OnCheck()
        {
            ...
            {
                // Caches the main damage receiver from the character that caused the damage
                // and sets the result to true indicating that the hurt condition has been met
                this.cacheFromCharacterDmgReceiver.value = damageInfo
                    .fromCharacter
                    .mainDamageReceiver;
                result = true;
            }
