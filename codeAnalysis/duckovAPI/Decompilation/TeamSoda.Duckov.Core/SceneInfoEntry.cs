...
public class SceneInfoEntry
{
    ...
    {
        get { return this.sceneReference; }
    }
    ...
    {
        get { return this.description.ToPlainText(); }
    }
    ...
    public bool IsLoaded
    {
        get
        {
            return this.sceneReference != null
                && this.sceneReference.UnsafeReason == SceneReferenceUnsafeReason.None
                && this.sceneReference.LoadedScene.isLoaded;
        }
    }
