...
set "AUTH_TOKEN=Bearer eyJhbGciOiJIUzM4NCJ9.eyJyb2xlIjoiQURNSU4iLCJ1c2VySWQiOjEsInN1YiI6ImFkbWluIiwiaWF0IjoxNzYyNjYwNDcyLCJleHAiOjE3NjI3NDY4NzJ9.6d2LQ-bKOVPo85-CepRmCoZFx7M7G4mPPlTA7AmvK1NyiUccL79y184qa5mVK-bO"
...
curl -s -X GET "http://127.0.0.1:8080/api/logs?clientId=2&page=0&size=900" ^
  -H "Accept: application/json" ^
  -H "Authorization: %AUTH_TOKEN%" ^
  -H "Cache-Control: no-cache" ^
  -o "logs_client.json"
